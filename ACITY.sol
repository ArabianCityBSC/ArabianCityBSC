...
contract ACITY is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 2 * 10**10 * 10**9; // 1% of the supply
    uint256 public maxSellAmount = 1 * 10**10 * 10**9; // 1% of the supply
    uint256 public maxWalletAmount = 5 * 10**10 * 10**9; // 5% of the supply
    ...
    address payable _marketingWallet = payable(address(0x54a8d4D0A688aCA45700F3EcC81481752858e728)); // MarketingWallet
    ...
    constructor() ERC20("Arabian City", "ACITY") {
        ...
        */
        _mint(owner(), 1 * 10**12 * (10**9)); //  1 QuadTrillion Tokens
    }
